...
defmodule ProtonStream.Port do
  ...
  @doc """
  Run a command in a similar way to System.cmd/3, but taking ProtonStream options

  This code is mostly copy/pasted from System.cmd/3's implementation so that
  it works similarly.
  """
  @spec cmd(ProtonStream.Options.t()) ::
  ...
  @spec port_options(ProtonStream.Options.t(), [String.t()]) :: list()
